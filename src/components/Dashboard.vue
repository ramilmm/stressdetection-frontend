<template>
  ...
  <header class="main-header">
    <div class="pull-left image">
          <img src="https://st2.depositphotos.com/5266903/8825/v/950/depositphotos_88254646-stock-illustration-patient-stress-icon.jpg" class="img-circle" alt="User Image" style="color: white; margin-left: 5px; margin-top: -6px; max-height: 40px">
          <span class="logoText">StressDetection</span>
        </div>
